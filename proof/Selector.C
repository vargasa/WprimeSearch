...
Int_t Selector(std::string files = "", Int_t fWorkers = 4, std::string elistfile = ""){
  ...
  TFile *f7a = TFile::Open("files/mc/2016/sf/2016LegacyReReco_ElectronMedium_Fall17V2.root","READ");
  auto SFElectronMediumID = static_cast<TH2F*>(f7a->Get("EGamma_SF2D"));
  SFElectronMediumID->SetName("SFElectronMediumID");
  SFDb->Add(SFElectronMediumID);
  ...
  SFElectronTrigger2->SetName("SFElectronTrigger2");
  SFDb->Add(SFElectronTrigger2);
  TFile *f2 = TFile::Open("files/mc/2017/sf/2017_ElectronMedium.root","READ");
  auto SFElectronMediumID = static_cast<TH2F*>(f2->Get("EGamma_SF2D"));
  SFElectronMediumID->SetName("SFElectronMediumID");
  SFDb->Add(SFElectronMediumID);
  ...
  SFElectronTrigger2->SetName("SFElectronTrigger2");
  SFDb->Add(SFElectronTrigger2);
  TFile *f7a = TFile::Open("files/mc/2018/sf/2018_ElectronMedium.root","READ");
  auto SFElectronMediumID = static_cast<TH2F*>(f7a->Get("EGamma_SF2D"));
  SFElectronMediumID->SetName("SFElectronMediumID");
  SFDb->Add(SFElectronMediumID);
