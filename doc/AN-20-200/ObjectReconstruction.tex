...
\begin{figure}
  \centering
  \subfigure[Projection on the $\rho-\phi$ plane. \label{fig:C_RhoPhi}]{\includegraphics[width=0.8\linewidth]{fig/Fireworks/C_RhoPhi.png}}
  \vfil
  \subfigure[Projection on the $\rho-z$ plane\label{fig:C_RhoZ}]{\includegraphics[width=0.40\linewidth]{fig/Fireworks/C_RhoZ.png}}
  \subfigure[3D view\label{fig:C_Rho3D}]{\includegraphics[width=0.40\linewidth]{fig/Fireworks/C_3D.png}}
  \caption{Example of the signature left on the detector by a signal-like event
