...
Figure \ref{fig:kFactors} shows the weight applied to each DY event,
Next-to-leading order QCD and Electroweak (EWK) corrections to the Drell-Yan
process are applied as a function of the reconstructed Z boson's transverse
momentum.
...
\begin{figure}[tph]
  \centering
  \subfigure[
    Invariant mmass distribution for the WZ candidates without applying MC Corrections:
    HLT, Lepton Identification, and QCD and EWK K-Factors.
  ]{\includegraphics[width=.8\textwidth]{fig/ScaleFactors/CR2_HMassWZ_CR1_A_Run2_HRun2_M600_NoSF.pdf}}
  \vfil
  \subfigure[
    Invariant mmass distribution for the WZ candidates applying HLT, Lepton identification scale
    factors and QCD and EWK K-Factors.
  ]{\includegraphics[width=.8\textwidth]{fig/ScaleFactors/CR2_HMassWZ_CR1_A_Run2_HRun2_M600_Central.pdf}}
  \caption{Differences between the distributions with and without accounting for MC/Data afficiencies and
  corrections}
  \label{fig:ClosureTest}
\end{figure}

Figure \ref{fig:ClosureTest} shows the Invariant mass distribution
for the WZ candidate prior and after applying the MC corrections
described in previous subsections. The figure shows how the corrections improve
the Data/MC ratio.
