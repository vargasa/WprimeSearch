...
\begin{figure}[tph]
  \centering
        \subfigure[Standard model WZ production MC simulations normalized pileup distributions]{\includegraphics[width=.28\textwidth]{fig/ScaleFactors/MC_Pileup_Linear.pdf}}
        \subfigure[Pileup profile from RunII Data, Linear Scale]{\includegraphics[width=.28\textwidth]{fig/ScaleFactors/GoldenPileup_Linear.pdf}}
        \subfigure[Pileup profile from RunII Data, Logarithmic Scale]{\includegraphics[width=.28\textwidth]{fig/ScaleFactors/GoldenPileup_LogScale.pdf}}
